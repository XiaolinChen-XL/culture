...
DEFAULT_TRAIN_CSV = ARTECULTURE_DIR / "arteculture_6792_downsampled_with_country_nonblank_region_split_v2_train.csv"
DEFAULT_OUTPUT_DIR = SCRIPT_DIR / "explanation_concept_extraction_gemini35"

CULTURE_TO_FILE = {
    "english": ARTECULTURE_DIR / "english_explanations_full.jsonl",
    "chinese": ARTECULTURE_DIR / "chinese_explanations_full.jsonl",
    "arabic": ARTECULTURE_DIR / "arabic_explanations_full.jsonl",
}
...
- key_association: the meaning, value, memory, symbol, or affective cue linked to that concept in the explanation.
...
5. Use concise English noun phrases for concepts and key associations.
6. One explanation may contain zero, one, or multiple extractions.
7. Keep evidence_span short and copied from the original text.
